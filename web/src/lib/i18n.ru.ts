...
export const ru: Record<string, string> = {
  ...
  'Unknown timezone': 'Неизвестный часовой пояс',
  'Shared': 'Общий',
  ...
  'Follow the server clock': 'По часам сервера',
  'Shared by the whole family, unlike the two settings above: it decides when today becomes tomorrow for due tasks, budget periods and recurring payments.':
    'Общая для всей семьи, в отличие от двух настроек выше: от неё зависит, когда сегодня становится завтра для сроков задач, периодов бюджета и регулярных операций.',
  'Today there:': 'Сейчас там:',
  'What and when': 'Что и когда',
  'What they sign in with, and where password recovery is sent. A new address arrives unconfirmed — until they open the link mailed to it, it cannot recover the account.': 'С этим адресом человек входит, на него же уходит восстановление пароля. Новый адрес приходит неподтверждённым: пока по ссылке из письма не перейдут, восстановить учётку через него нельзя.',
  'Where': 'Где',
  ...
  'Notes, tasks and projects from before the key existed are still readable on the server. This rewrites them under the key, here in your browser; each member does it once for their private notes.':
    'Заметки, задачи и проекты, созданные до появления ключа, всё ещё читаются на сервере. Это перезапишет их под ключом прямо в браузере; свои приватные заметки каждый участник шифрует сам, один раз.',
